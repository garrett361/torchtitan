...
from torchtitan.models.moe.moe import MoE, MoEArgs, MoEClone, MoEEmptyLike

if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("cls", choices=["moe", "moe_clone", "moe_empty_like"])
    ...
    if args.cls == "moe":
        cls = MoE
    elif args.cls == "moe_clone":
        cls = MoEClone
    elif args.cls == "moe_empty_like":
        cls = MoEEmptyLike
    else:
        raise ValueError
