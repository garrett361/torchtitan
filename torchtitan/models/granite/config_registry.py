...
def granite_4_1_8b_sft() -> Trainer.Config:
    ...
    Requires GRANITE_CKPT_PATH and GRANITE_DATA1_PATH set in the environment
...
def granite_4_1_8b_base() -> Trainer.Config:
    ...
    Requires GRANITE_CKPT_PATH set in the environment or a .env file at the
    ...
    if ckpt_path is None:
        raise ValueError(
            "GRANITE_CKPT_PATH not set. Add it to .env or export it before running."
        )
